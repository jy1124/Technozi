...
<meta name="viewport" content="width=device-width,height=device-height,initial-scale=1.0maximum-scale=1.0, user-scalable=no" />
	...
	<style>
		...
		.vaccineSubMenuContainer input[type=submit], .pastCheckInContainer input[type=submit] {
			position: absolute;
			bottom: 10%;
			width: 100%;
			text-align: center;
...
<body>
	...
	<div class="publicUserHomeContainer">
		...
		<form method="post" action="HomeUI">
			<button class="announcementContainer" type="submit" name="announcement" value="View Announcement">View Announcement
			</button>
		</form>
		
		<div class="homeSubMenuContainer">
			<form method="post" action="HomeUI">
				<button class="vaccineSubMenuContainer" type="submit" name="vaccineCert" value="View Vaccine Cert">
					<img src="img/vaccineShield.png">
					<p>View Vaccine Cert</p>
				</button>
			</form>
			
			<form method="post" action="HomeUI">
				<button class="pastCheckInContainer" type="submit" name="visitHistory" value="View Past Check-Ins">
					<img src="img/pastCheckin.png">
		...
		<div class="homeActionsContainer">
			<form method="post" action="HomeUI">
				<button class="checkInButton" type="submit" name="checkIn" value="Check In">
					Check In</button>
			</form>
			
			<form method="post" action="HomeUI">
				<button class="checkOutButton" type="submit" name="checkOut" value="Check Out">
				Check Out</button>
			</form>
		</div>
			<form method="post" action="HomeUI">

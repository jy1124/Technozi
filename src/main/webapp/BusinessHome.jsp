...
<meta name="viewport" content="width=device-width,height=device-height,initial-scale=1.0maximum-scale=1.0, user-scalable=no" />
	...
	<style>
		...
		.profilePictureHolder {
			...
			width: 200px;
			height: 200px; 
			background-image: url("img/businessProfile1.jpg");
			background-repeat: no-repeat;
			background-size: cover;
			left: 50%;
			transform: translateX(-50%);
...
<body>
	...
	<div class="businessUserHomeContainer">
		...
		<form method="post" action="BusinessHomeUI">
			<button class="homeSubMenuContainer" type = "submit" name="generateCheckIn" value="Generate Past Check-Ins">
					<div class="pastCheckInContainer">
						<img src="img/pastCheckin.png">
						<p>Generate Past Check-Ins</p>
					</div>
			</button>
		</form>

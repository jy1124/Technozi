...
<body>
	...
	<div class="checkInContainer">
		<div class="navbar">		
			...
			<p class="vaccineInfoHeader">Account Management</p>
		</div>
		...
		<form method="post" action="AccountsManagementUI">
			<table>
				<tr>
					<td colspan="3" >
						<button style="background: #008000;" class="modify" name="addAccount" value="Add Account">Add/Create Account</button>
					</td>
				</tr>
				<tr>
					<td colspan="3" >
						<button style="background: #FFA500;" class="modify" name="updateAccount" value="Update Account">Update/Modify Account</button>
					</td>
				</tr>
				<tr>
					<td colspan="3" >
						<button style="background: #FF0000;" class="modify" name="suspendAccount" value="Suspend Account">Suspend Account</button>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<button style="background: #008000;" class="modify" name="unsuspendAccount" value="UnSuspend Account">Unsuspend Account</button>
					</td>
				</tr>
			</table>
		</form>
